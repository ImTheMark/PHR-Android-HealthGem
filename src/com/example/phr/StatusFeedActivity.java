...
public class StatusFeedActivity extends ListActivity {
	...
	private List<Status> generateData() {
		...
		feeling.setPostViaImgUrl(getResources().getDrawable(R.drawable.activitystatusfeed_icon_small_facebook));
		...
		eat.setPostViaImgUrl(getResources().getDrawable(R.drawable.activitystatusfeed_heart_gem_supersmall));
		...
		eat2.setPostViaImgUrl(getResources().getDrawable(R.drawable.activitystatusfeed_heart_gem_supersmall));
		...
		eat3.setPostViaImgUrl(getResources().getDrawable(R.drawable.activitystatusfeed_heart_gem_supersmall));
		...
		doing.setPostViaImgUrl(getResources().getDrawable(R.drawable.activitystatusfeed_icon_small_facebook));
		...
		eat4.setPostViaImgUrl(getResources().getDrawable(R.drawable.activitystatusfeed_icon_small_facebook));
		...
		eat5.setPostViaImgUrl(getResources().getDrawable(R.drawable.activitystatusfeed_heart_gem_supersmall));
		...
		drink2.setPostViaImgUrl(getResources().getDrawable(R.drawable.activitystatusfeed_heart_gem_supersmall));
