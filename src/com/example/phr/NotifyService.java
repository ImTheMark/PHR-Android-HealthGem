...
public class NotifyService extends Service {
	...
	public static final String INTENT_NOTIFY = "com.example.phr.INTENT_NOTIFY";
	...
	private void showNotification() {
		...
		// notification
		PendingIntent contentIntent = PendingIntent.getActivity(HealthGem
				.getContext(), 0, new Intent(HealthGem.getContext(),
