...
public class WeightAdapter extends BaseAdapter {
	...
	private List<List<Weight>> mListOfGroupedWeightByDate;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		String month = DateTimeParser.getMonth(mListOfGroupedWeightByDate.get(position).get(0).getTimestamp());
		String day = DateTimeParser.getDay(mListOfGroupedWeightByDate.get(position).get(0).getTimestamp());
		float average = 0;
