...
/*	@Override
	...
	public List<UnverifiedFoodEntry> getAllUnverifiedFoodPosts()
		...
		UnverifiedFoodEntry e1 = new UnverifiedFoodEntry("1234567890",
				timestamp, "I ate a chocolate cake", null, food, 1.0,
				"chocolate cake");

		food.setName("Cheesecake");

		UnverifiedFoodEntry e2 = new UnverifiedFoodEntry("1234567890",
				timestamp, "Cheesecake for desert. YUM YUM YUM!", null, food,
				1.0, "Cheesecake");

		food.setName("Fried Chicken");

		UnverifiedFoodEntry e3 = new UnverifiedFoodEntry("1234567890",
				timestamp, "Dinner today: chicken! Yaaaay", null, food, 1.0,
				"chicken");
	...
	public List<UnverifiedActivityEntry> getAllUnverifiedActivityPosts()
		...
		UnverifiedActivityEntry e1 = new UnverifiedActivityEntry("1234567890",
				timestamp, "Good morning #jogging", null, activity, 2832, 14.0,
				"Jogging");

		Activity activity2 = new Activity("Swimming", 54.0);

		UnverifiedActivityEntry e2 = new UnverifiedActivityEntry("1234567890",
				timestamp, "Having some fun swimming with my friends", null,
				activity2, 2235832, 14.0, "Swimming");

		Activity activity3 = new Activity("Yoga", 23.0);

		UnverifiedActivityEntry e3 = new UnverifiedActivityEntry("1234567890",
				timestamp, "Yoga with mommy :)", null, activity3, 243535, 14.0,
				"Yoga");
	...
	public List<UnverifiedRestaurantEntry> getAllUnverifiedRestaurantPosts()
		...
		UnverifiedRestaurantEntry e1 = new UnverifiedRestaurantEntry(
				"2142323432", timestamp, "Here at KFC!", null, "KFC",
				restaurant, null);

		Restaurant restaurant2 = new Restaurant(2343423, "Mang Inasal");

		UnverifiedRestaurantEntry e2 = new UnverifiedRestaurantEntry(
				"2142323432", timestamp,
				"Mang Inasal is so delicious. I can't stop eating it.", null,
				"Mang Inasal", restaurant2, null);

		Restaurant restaurant3 = new Restaurant(2343423, "Starbucks");

		UnverifiedRestaurantEntry e3 = new UnverifiedRestaurantEntry(
				"2142323432", timestamp, "Starbucks today!", null, "Starbucks",
				restaurant3, null);
	...
	public List<UnverifiedSportsEstablishmentEntry> getAllUnverifiedSportsEstablishmentPosts()
		...
		SportEstablishment sportEstablishment1 = new SportEstablishment(34234,
				"Gold's Gym");

		UnverifiedSportsEstablishmentEntry e1 = new UnverifiedSportsEstablishmentEntry(
				"34346436643", timestamp, "Workout at Gold's Gym", null,
				"Gold's Gym", sportEstablishment1, null);

		SportEstablishment sportEstablishment2 = new SportEstablishment(34234,
				"Fitness First");

		UnverifiedSportsEstablishmentEntry e2 = new UnverifiedSportsEstablishmentEntry(
				"34346436643", timestamp, "Here at Fitness First with friends",
				null, "Fitness First", sportEstablishment2, null);
